...
<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modalAddAlcoholicDrink">
    <img src="../assets/images/add.png" width="50px" title="Agregar licor">
</button>

<div class="modal fade" id="modalAddAlcoholicDrink" tabindex="-1" aria-labelledby="tittleAddAlcoholicDrink"
    aria-hidden="true">
